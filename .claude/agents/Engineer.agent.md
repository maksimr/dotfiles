...
<workflow>
1. **Understand** — read the task, locate relevant code (delegate broad sweeps to the Explore agent), read affected files and their callers
...
6. **Self-review** — delegate the final diff to the Reviewer agent; fix critical/major findings, report minor ones
